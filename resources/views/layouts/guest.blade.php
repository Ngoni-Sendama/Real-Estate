...
<body>
    ...
    <footer>
        <div class="container">
            <div class="col-lg-8">
                <p>Copyright © 2024 {{config('app.name')}}. All rights reserved.

                    Design: <a rel="nofollow" href="https://portfolio.innovationalroom.tech" target="_blank">Innovational Room</a></p>
            </div>
        </div>
    </footer>
