            ...
            <div class="row">
                @foreach ($apartments as $apartment)
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                            <a href="property-details.html"><img src="{{ asset('storage/' . $apartment->images[0]) }}"
                                    alt=""></a>
                            <span class="category">{{ $apartment->category->name }}</span>
                            <h6>${{ $apartment->price_per_month }}</h6>
                            <h4><a href="property-details.html">{{ $apartment->name }}</a></h4>
                            <ul>
                                <li>Bedrooms: <span>{{ $apartment->number_of_bedrooms }}</span></li>
                                <li>Bathrooms: <span>{{ $apartment->number_of_bathrooms }}</span></li>
                                <li>internet_connection: <span>
                                        @if ($apartment->internet_connection == false)
                                            ❌
                                        @else
                                            ✅
                                        @endif
                                    </span></li>
                                <li>solar backup: <span>
                                        @if ($apartment->solar_system == false)
                                            ❌
                                        @else
                                            ✅
                                        @endif
